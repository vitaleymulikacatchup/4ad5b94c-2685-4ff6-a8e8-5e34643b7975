...
export const metadata: Metadata = {
  title: "Krasotka | Premium Models Agency",  description: "Discover exceptional professional models and talent management services. Krasotka connects top models with prestigious brands and international campaigns.",  keywords: "models agency, professional models, fashion talent, model representation, casting services",  metadataBase: new URL("https://krasotka.agency"),
  alternates: {
    canonical: "https://krasotka.agency"
  },
  openGraph: {
    title: "Krasotka | Premium Models Agency",    description: "Premier luxury models agency representing exceptional talent for fashion, commercial, and editorial work.",    url: "https://krasotka.agency",    siteName: "Krasotka",    type: "website",    images: [
      {
        url: "https://img.b2bpic.net/free-photo/blond-female-long-red-dress-motion-studio-shoot_613910-309.jpg",        alt: "Krasotka Models Agency"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Krasotka | Premium Models Agency",    description: "Discover exceptional professional models and world-class agency services",    images: ["https://img.b2bpic.net/free-photo/blond-female-long-red-dress-motion-studio-shoot_613910-309.jpg"]
  },
  robots: {
    index: true,
    follow: true
